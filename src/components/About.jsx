...
const About = () =>{
    return (
        ...
        <h2> Our Goal:</h2>
        <h5>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum quae aut molestiae saepe aspernatur nemo ullam quibusdam quaerat quos soluta rem hic maxime aliquid, eos, quidem adipisci. Nesciunt, modi in!</h5>
